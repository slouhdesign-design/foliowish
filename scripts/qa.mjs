...
const required = ['index.html','editor.html','assets/site.css','assets/editor.css','js/editor.js','robots.txt','sitemap.xml','privacy.html','terms.html','404.html'];
...
const editor=existsSync(join(root,'js/editor.js'))?readFileSync(join(root,'js/editor.js'),'utf8'):'';
...
console.log(`FolioWish QA passed: ${htmlFiles.length} HTML files checked, ${publicMode?'public':'pre-launch'} mode valid, internal links clean, no obvious secrets or editor network calls found.`);
